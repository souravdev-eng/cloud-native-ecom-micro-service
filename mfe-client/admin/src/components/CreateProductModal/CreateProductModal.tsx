            ...
            <div className="modal-container">
                ...
                <div className="modal-header">
                    <div>
                        ...
                        <p className="modal-subtitle">Add a new product to your catalog</p>
                    </div>
                    ...
                    <div className="form-grid">
                        ...
                        <div className="form-column">
                            ...
                            <div className="pricing-section">
                                ...
                                {/* Discount Preview */}
                                {formData.originalPrice && formData.sellingPrice && Number(formData.originalPrice) > Number(formData.sellingPrice) && (
                                    <div className="discount-badge">
                                        {Math.round((1 - Number(formData.sellingPrice) / Number(formData.originalPrice)) * 100)}% OFF
                                    </div>
                                )}
                            </div>
