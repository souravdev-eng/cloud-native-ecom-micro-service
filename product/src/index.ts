    ...
    try {
        ...
        mongoose
            .connect(process.env.PRODUCT_SERVICE_MONGODB_URL, {
                user: process.env.PRODUCT_SERVICE_MONGODB_USER,
                pass: process.env.PRODUCT_SERVICE_MONGODB_PASSWORD,
            })
